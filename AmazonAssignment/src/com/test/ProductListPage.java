...
public class ProductListPage {
    ...
    public static void ValidateListofProducts(WebDriver driver) {
    	...
    	try {
    		...
    		Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/amazon_auto","root","Akash@123");
    		Statement stmt = conn.createStatement();

    		ResultSet res = stmt.executeQuery("select * from amazon_pod");
